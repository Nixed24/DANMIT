...
#VTEX_PATH = "G:\SteamLibrary\steamapps\common\GarrysMod\bin\vtex"
...
normal_map_image.save(NMAP_FILENAME_NOEXT + "_normal.tga")
normal_map_path = getcwd() + "\\" + NMAP_FILENAME_NOEXT + "_normal.tga"
normal_map_param_path = getcwd() + "\\" + NMAP_FILENAME_NOEXT + "_normal.txt"
